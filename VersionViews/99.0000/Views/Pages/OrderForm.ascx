            ...
            <div class="u-pad">
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                <input type="radio" data-eflex="draw"  name="ActionCode0" value="OPTEFAIR">
                            </span>
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                <input type="radio" data-eflex="draw"  name="ActionCode0" value="OPTEMEDIUM">
                            </span>
                            <span class="col u-pad--left">
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                <input type="radio" data-eflex="draw" data-instock="false" value="OPTEDEEP" name="ActionCode0" data-href="#leadform" data-remote-name="LeadForm" class="button button--primary button--visible get-modal get-modal--remote" title="<%= CampaignName %> Deep Tone">
                            </span>
                            <span class="col u-pad--left">
                ...
                <input type="hidden" name="ActionQuantity0" value="1" id="ActionQuantity0" />
            </div>
                ...
                <fieldset id="paymentForm" class="c-brand--form__fieldset">
                    ...
                    <div class="checkout-option" id="divPaypal" style="display: block;">
                        ...
                        <label class="label" for="paypal">
                            <img src="/shared/images/PP_Acceptance_Marks_for_LogoCenter_76x48.png" />
                        </label>
                    </div>
                    <br />
                    <div class="checkout-option" id="divCARD">
                        ...
                        <label class="label ccImage " for="card">
                            <img id="visaImg" src="/shared/images/visa.png?ts=636723473060187969" alt="visa accepted." style="width:37px;">
                            <img id="mastercardImg" src="/shared/images/mastercard.png?ts=636723473060187969" alt="mastercard accepted." style="width:37px;">
                            <img id="amexImg" src="/shared/images/amex.png?ts=636723473060187969" alt="amex accepted." style="width:37px;">
                            <img id="discoverImg" src="/shared/images/discover.png?ts=636723473060187969" alt="discover accepted." style="width:37px;">
                        </label>
                    </div>
                    <br />
                ...
                <fieldset id="calltoAction">
                    ...
                    <ul class="c-brand--form__list u-pad @dv-u-pad--horz">
                        ...
                        <li class="c-brand--form__item o-grid--vert--center u-vw--100 u-mar--top fn--center">
                            <p class="u-mar--bottom @x2-mar">Our two-year warranty covers all servicing/replacement. Should an issue arise, contact us here. We also reserve the right to re-purchase <%= CampaignName %>, covering all costs and shipping, within two years from purchase. Checking out signifies acceptance of our warranty, <a href="https://www.pg.com/en_US/terms_conditions/index.shtml" class="has-popup" title="<%= CampaignName %> | Terms and Conditions">Terms & Conditions</a>, and buyback policies as well as awareness of our <a href="https://www.pg.com/privacy/english/privacy_statement.shtml" title="<%= CampaignName %> | Privacy" class="has-popup">Privacy Policy.</a></p>
                              
                            <img id="paypalBt" style="display:none;" src="/shared/images/pp-checkout-logo-large.png"/>
                            <button  id="AcceptOfferButton" name="acceptOffer" class="button button--primary button--visible" title="Order <%= CampaignName %> Today">Process Order</button>
                        </li>
