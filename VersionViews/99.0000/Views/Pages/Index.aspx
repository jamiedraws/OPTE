...
<header class="header header--has-bg">
	...
	<div class="header__in">
		...
		<div class="header__hero">
			...
			<img class="hero__after" src="/images/2.0000/hero-opte.png?appV=<%= DtmContext.ApplicationVersion %>" alt="After how <%= CampaignName %> looks">
		...
		<div class="section__in">
			...
			<aside class="offer__aside">
				...
				<div class="aside__list">
					...
					<ul class="aside__ul">
						<li>Makes skin imperfections instantly disappear and helps fade their appearance over time</li>
		...
		<div class="section__in">
			...
			<div class="works__grid grid--has-float-image">
				<div class="works__content">
					...
					<p><%= CampaignName %> digitally scans skin, detects every imperfection and instantly corrects each one with the tone-matching mineral pigments that make them virtually impossible to see and tone perfecting serum that actually helps fade their appearance away over time.</p>
