            ...
            <div class="u-pad product">
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                 <input class="product__item" type="radio" data-eflex="draw" name="Options" id="OPTEFAIR" data-code="OPTEFAIR">
                            </span>
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                <input class="product__item" type="radio" data-eflex="draw" name="Options" id="OPTEMEDIUM" data-code="OPTEMEDIUM">
                            </span>
                            <span class="col u-pad--left">
                ...
                <label class="c-brand--form__grid">
                    <div class="c-brand--form__grid__item">
                        <div class="row-to-center c-brand--form__grid__group fn--ucase">
                            <span class="col">
                                 <input type="radio" data-eflex="draw" data-instock="false" data-code="OPTEDEEP" id="OPTEDEEP" name="Options" data-href="#leadform" data-remote-name="LeadForm" class="button button--primary button--visible get-modal get-modal--remote product__item" title="<%= CampaignName %> Deep Tone">
                            </span>
                            <span class="col u-pad--left">
