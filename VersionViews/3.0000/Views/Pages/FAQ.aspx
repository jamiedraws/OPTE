            ...
            <div class="faq__container">
                ...
                <ul class="faq__ul">
                    <li>
                        ...
                        <div class="faq__answer">
                            <p>Go to the <a href="index<%= Model.Extension %>#how-to-use" title="Learn how to use <%= CampaignName %>">How to Use</a> section of the website for detailed instructions.</p>
                        </div>
                    </li>
                    <li>
                        <button class="faq__question">
