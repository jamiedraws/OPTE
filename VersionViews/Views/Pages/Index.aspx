...
<style>
    ...
    * --------------------------------------------------------------------- */
    ...
    @media all and ( min-width : 0 ) and ( max-width : 992px ) {
        ...
        .hero__before {
            width: 45.052083333333336vw;
            height: 42.317708333333336vw;
            max-width: 368px;
            max-height: 345px;
            position: absolute;
            top: 15vw;
        ...
        .hero__after {
            width: 75.13020833333334vw;
            height: 73.69791666666667vw;
            right: 0;
            position: relative;
            display: block;
            left: 35vw;
	...
	<div class="header__in">
		...
		<div class="header__hero">
			...
			<div class="hero__content">
				...
				<p>the world's first digital-age skin-perfecting system... proven to make spots and imperfections INSTANTLY disappear, AND help fade their appearance over time...</p>
				<img class="hero__before" src="/images/hero-opte-before.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Before without <%= CampaignName %>">
			</div>

			<img class="hero__after" src="/images/hero-opte-after.png?appV=<%= DtmContext.ApplicationVersion %>" alt="After how <%= CampaignName %> looks">
...
<main class="main">
		...
		<div class="section__in">
			...
			<aside class="offer__aside">
				...
				<div class="aside__list">
					...
					<ul class="aside__ul">
						<li>Makes skin imperfections instantly disappear and fade over time</li>
					...
					<div class="aside__center">
						<a href="#offer" class="button button--primary" title="Try <%= CampaignName %> for a free trial today!">
		...
		<div class="section__in">
			...
			<div class="use__items">
				<figure class="use__item">
					<div class="use__img" data-src-img="/images/step-1.png?appV=<%= DtmContext.ApplicationVersion %>" data-alt="Step 1"></div>
					<figcaption>
						<em class="use__em">Step 1</em>
						<p>Place the Wand Tip on the Beauty Wand.</p>
					</figcaption>
				</figure>

				<figure class="use__item">
					<div class="use__img" data-src-img="/images/step-2.png?appV=<%= DtmContext.ApplicationVersion %>" data-alt="Step 2"></div>
					<figcaption>
						<em class="use__em">Step 2</em>
						<p>Keep the Beauty Wand flat to the skin with rollers lightly touching the skin at all times.</p>
					</figcaption>
				</figure>

				<figure class="use__item">
					<div class="use__img" data-src-img="/images/step-3.png?appV=<%= DtmContext.ApplicationVersion %>" data-alt="Step 3"></div>
					<figcaption>
						<em class="use__em">Step 3</em>
						<p>Slowly glide the Beauty Wand back and forth on long, deliberate strokes.</p>
					</figcaption>
				</figure>
			</div>

			<a href="#offer" class="button button--primary" title="Sign up for a 30-Day free trial with <%= CampaignName %>">Get Your 30-Day Free Trial</a>
		...
		<div class="section__in">
			...
			<div class="works__grid grid--has-float-image">
				<div class="works__content">
					...
					<p><%= CampaignName %> digitally scans skin, detects every imperfection and instantly corrects each one with the tone-matching mineral pigments that make them virtually impossible to see and tone perfecting serum that actually fades them away over time.</p>
			...
			<div class="works__grid grid--has-inline-columns">
				<div class="works__content">
					...
					<p>Today's solutions for age spots are inferior.<br>
					<%= CampaignName %> goes beyond, to reveal a naturally flawless look you've never seen before&mdash; the stunning look of micro-perfected skin!</p>
				</div>
			</div>

			<div id="how-it-works" class="works__section">
				<h2 class="works__title">How it targets</h2>
				<p class="works__desc">By combining the best of smart technology and skin care <%= CampaignName %> produces a superior solution for age spots. Targeting only imperfections, your skin looks and feels naturally flawless.</p>
	...
	<section id="ingredients" class="section section--ing" data-lazy-load-progressive="0.25" data-lazy-load-background>
		...
		<div class="box-line">
			...
			<a href="#offer" class="box-line__front button button--primary" title="Sign up for a 30-Day free trial with <%= CampaignName %>">Get Your 30-Day Free Trial</a>
		</div>

		<div class="section__in">

			<h2 class="ing__title"><span class="title__block">A mix of </span>organic & natural ingredients</h2>
			...
			<div class="ing__grid">
				<div class="ing__content">
					...
					<strong class="ing__strong">Skin Improves in just a Short Time</strong>
