...
<div class="works__figure">
    ...
    <figure>
        ...
        <figcaption class="works__figcaption">
            <em>Detects</em>
            <p>A microprocessor analyzes your age spots and customizes the serum instantly.</p>
        </figcaption>
    </figure>
    <figure>
        ...
        <figcaption class="works__figcaption">
            ...
            <p>The customized serum is applied precisely to each micro-imperfection, providing immediate coverage and long term benefits.</p>
        </figcaption>
    </figure>
</div>