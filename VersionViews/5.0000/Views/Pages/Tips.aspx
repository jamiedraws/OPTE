	...
	<section class="section section--tips section--line--bottom" data-lazy-load-progressive="0.25">
		...
		<div class="section__in">
            ...
            <div class="tips__grid">
                ...
                <div class="tips__item">
                    <h2 class="tips__title">Instructional</h2>
                    <div data-src-iframe class="section__offset">
                        <iframe class="section__video fade-content-in" src="https://www.youtube.com/embed/ug0GxvasNmU?modestbranding=1&showinfo=1&rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    .user__item .section__video,
    .user__item .section__video > iframe,
    .section__offset, 
    .section__offset > iframe {
        width: 82vw;
        height: 46vw;
    }
    ...
    @media all and ( min-width : 0 ) and ( max-width : 1024px ) {
        .section--system .section__video,
        .section--system .section__video > iframe {
            width: 96vw;
            height: 53.980469vw;
        }
