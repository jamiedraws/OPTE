...
<main class="main">
	...
	<section class="section section--offer section--line--bottom">
		...
		<div class="section__in">
			...
			<aside class="offer__aside">
                ...
                <div class="aside__video omit-placeholder-background" data-src-iframe="https://player.vimeo.com/video/312127852?playsinline=1&title=0&byline=0&portrait=0" data-src-attr='{ "frameborder" : "0", "webkitallowfullscreen" : "true", "mozallowfullscreen" : "true", "allowfullscreen" : "true" }'></div>
				...
				<div class="aside__list">
					...
					<ul class="aside__ul">
						...
						<li>Cartridges last 60 days with daily use</li>
					...
					<div class="aside__center">
						...
						<button data-href="#offerincludes" data-snippet-name="FORMTOP" class="button button--secondary get-modal get-modal--snippet" title="See what's included with our <%= CampaignName %> offer">
	...
	<section id="how-to-use" class="section section--use" data-lazy-load-progressive="0.25" data-lazy-load-background>
		...
		<div class="section__in">
			...
			<a href="#offer" class="button button--primary" title="Sign up for a 30-Day risk free offer with <%= CampaignName %>">Get Your 30-Day Risk Free Offer!</a>
		...
		<div class="section__in">
			...
			<div class="works__section">
				...
				<div class="works__illustration">
                    <figure class="illustration__before mobile__before__icons" data-src-img="/images/before-opte.png?appV=<%= DtmContext.ApplicationVersion %>" data-alt="Before <%= CampaignName %>; cleanse, treat, moisturize, SPF"></figure> 
                
                    <figure class="illustration__before mobile__before__icons__show" data-src-img="/images/before-opte-mobile.png?appV=<%= DtmContext.ApplicationVersion %>" data-alt="Before <%= CampaignName %>; cleanse, treat, moisturize, SPF"></figure>
                    ...
                    <figure class="illustration__after mobile__before__icons" data-src-img="/images/after-opte.png?appV=<%= DtmContext.ApplicationVersion %>1" data-alt="After <%= CampaignName %>; powder &amp; color cosmetics"></figure>
                    
                    <figure class="illustration__after mobile__before__icons__show" data-src-img="/images/after-opte-mobile.png?appV=<%= DtmContext.ApplicationVersion %>1" data-alt="After <%= CampaignName %>; powder &amp; color cosmetics"></figure>
				</div>
			</div>
			...
			<div class="works__grid grid--has-inline-columns">
				<div class="works__content">
                    ...
                    <div class="works__video" data-src-iframe="https://player.vimeo.com/video/312127852?playsinline=1&title=0&byline=0&portrait=0" data-src-attr='{ "frameborder" : "0", "webkitallowfullscreen" : "true", "mozallowfullscreen" : "true", "allowfullscreen" : "true" }'></div>
                    <p>
	...
	<section id="ingredients" class="section section--ing" data-lazy-load-progressive="0.25" data-lazy-load-background>
		...
		<div class="box-line">
			...
			<a href="#offer" class="box-line__front button button--primary" title="Sign up for a 30-Day risk free offer with <%= CampaignName %>">Get Your 30-Day Risk Free Offer!</a>
		</div>
...
<style>
    ...
    * --------------------------------------------------------------------- */
    ...
    /* here is my awesome css ninja skills */
    @media all and ( max-width : 992px ) {
        .works__illustration .mobile__before__icons {
            display: none;
        }
    }

    @media all and ( min-width : 993px ) {
        .works__illustration .mobile__before__icons__show {
            display: none;
        }
    }
    ...
    .works__illustration .illustration__after {
        width: 236px;
        height: 299px;
        padding-top: 1.25rem;
        margin-bottom: 5rem;
