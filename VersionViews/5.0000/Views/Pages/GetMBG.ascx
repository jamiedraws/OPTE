...
<div class="offer__mbg mbg">
    ...
    <div class="mbg__content">
        ...
        <p>Buy <%= CampaignName %> risk-free today! Only pay 4 monthly payments of $125 per month. If you are not satisfied within 30 days, contact our customer service line for a prepaid label. Then, just send the system back.</p>
    </div>
</div>