if(typeof (___jqueryUI) != 'undefined' && ___jqueryUI){
	console.log('jquery-ui already loaded... cleaing up.');
	$('link[href*="jquery-ui"]').hide().after('<link href="/Shared/css/jquery-ui.custom.min.css" rel="stylesheet" type="text/css">');
}else{
/*!
 * jQuery UI 1.8.17
 *
